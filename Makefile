...
SOURCES = \
	__init__.py \
	pian_exporter.py pian_exporter_dialog.py

PLUGINNAME = pian_exporter

PY_FILES = \
	__init__.py \
	pian_exporter.py pian_exporter_dialog.py

UI_FILES = pian_exporter_dialog_base.ui
...
QGISDIR=C:\Users\lecbych\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
